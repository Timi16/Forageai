...
import { Menu, Brain, Upload, Database, Zap, User } from "lucide-react";
      ...
      <div className="container flex h-20 items-center justify-between px-6">
        <div className="flex items-center space-x-4">
          <Link href="/" className="flex items-center space-x-3 group">
            ...
            <Badge
              variant="outline"
              className="hidden sm:inline-flex border-slate-600 text-slate-400 bg-slate-900/50"
            >
              Enterprise
            </Badge>
          </Link>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-400 font-light">
                          Enterprise-grade model repository
                        </div>
                      </div>
                    </Link>
                  </NavigationMenuLink>
        ...
        <div className="flex relative md:left-16 lg:left-18 items-center justify-end">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="right"
              className="w-[350px] bg-slate-950/95 backdrop-blur-md border-l border-slate-800"
            >
